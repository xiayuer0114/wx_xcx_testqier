 ...
 *
 */
public class MerchantRedEnvelopeSharingRule extends BaseModel{
	 ...
	 * 共享商户
	 */
	private User user_merchant_gongxiang;
	/**
	 * 共享商户系统编号
	 */
	private String user_merchant_gongxiang_id;
	...
	static{
		putConfig(MerchantRedEnvelopeSharingRule.class, "state_"+State.STATE_OK, "已领取");
		putConfig(MerchantRedEnvelopeSharingRule.class, "state_"+State.STATE_CLOSED, "已过期");
	}
	...
	public User getUser_merchant_gongxiang() {
		if(MyUtil.isValid(user_merchant_gongxiang_id)) {
			user_merchant_gongxiang= (User) ContextUtil.getSerializContext().findOne(User.class, user_merchant_gongxiang_id);
		}
		return user_merchant_gongxiang;
	}
	public void setUser_merchant_gongxiang(User user_merchant_gongxiang) {
		this.user_merchant_gongxiang = user_merchant_gongxiang;
	}
	public String getUser_merchant_gongxiang_id() {
		return user_merchant_gongxiang_id;
	}
	public void setUser_merchant_gongxiang_id(String user_merchant_gongxiang_id) {
		this.user_merchant_gongxiang_id = user_merchant_gongxiang_id;
	}
	@Override
	public String toString() {
		return "MerchantRedEnvelopeRule [user_merchant_xiaofei=" + user_merchant_xiaofei + ", user_merchant_xiaofei_id="
				+ user_merchant_xiaofei_id + ", user_merchant_gongxiang=" + user_merchant_gongxiang
				+ ", user_merchant_gongxiang_id=" + user_merchant_gongxiang_id + ", state=" + state
