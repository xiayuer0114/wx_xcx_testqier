 ...
 * 618红包活动
 */
public class RedEnvelopes618 extends BaseModel {
	...
	private User72 user72;
	 ...
	 static{
			putConfig(RedEnvelopes618.class, "state_"+State.STATE_WAITE_PROCESS, "等待传图");
			putConfig(RedEnvelopes618.class, "state_"+State.STATE_OK, "已回传图");
			putConfig(RedEnvelopes618.class, "state_"+State.STATE_WAITE_PAY, "已发放");
			putConfig(RedEnvelopes618.class, "state_"+State.STATE_PAY_SUCCESS, "已使用");
