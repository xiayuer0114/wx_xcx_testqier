...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    toggleMeridian: function() {
      this.meridian = this.meridian === '上午' ? '下午' : '上午';
    },
    ...
    widgetKeydown: function(e) {
      var $input = $(e.target),
          n上午e = $input.attr('class').replace('bootstrap-timepicker-', '');

      switch (e.keyCode) {
      case 9: //tab
        if ((this.showMeridian && n上午e === 'meridian') || (this.showSeconds && n上午e === 'second') || (!this.showMeridian && !this.showSeconds && n上午e === 'minute')) {
