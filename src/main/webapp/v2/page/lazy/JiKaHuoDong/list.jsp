		...
		<tbody>
			<c:forEach var="object" varStatus="i" items="${object_ite }">
				<tr target="id" rel="${object.id }" id="${object.id }">
					...
					<td><c:out value="${object.choujiang_jine}" escapeXml="true"/></td>
					<td><c:out value="${object.jika_paiming }" escapeXml="true"/></td>
					<td><c:out value="${object.state }" escapeXml="true"/></td>
