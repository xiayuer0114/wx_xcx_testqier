		...
		<div class="pageFormContent"  > 
			<fieldset  >
					...
					<dl >
						<dt>原状态：</dt>
						<dd> 
							<select class="combox" name="object.old_state" svalue="<%=State.STATE_WAITE_CHANGE %>">
					...
					<dl >
						<dt>目标状态：</dt>
						<dd>
							<select class="combox" name="object.new_state" svalue="<%=State.STATE_OK %>">
					...
					<div class="divider"></div>
					<dl>
						<dt style="font-size: 0.8rem;">领取商家随机</dt>
						<dd>
							<input checked="checked" type="checkbox"  name="user_merchant_lingqu_rand" value="<%=State.STATE_OK %>"    >
						</dd>
					</dl>
					...
					<%-- <dl>
						<dt>领取商家</dt>
						<dd>
							<input type="text" bringBack="user_merchant_lingqu.showName"     value="<c:out value="${object.user_merchant_lingqu.showName }" escapeXml="true"/>"   >
							<input type="hidden" bringBack="user_merchant_lingqu.userId_merchant_lingqu" name="object.userId_merchant_lingqu" value="${object.userId_merchant }"    >
							<a  class="btnLook" href="${basePath }v2/huiyuan/list.do?return_mod=lookup&userGroup_id=<%=CashierAction.getMerchantUserGroutId() %>" lookupGroup="user_merchant_lingqu"  rel="user_merchant_lingqu_lookup">查找</a>
						</dd>
					</dl> --%>
					
					<!-- 之前代码领取商家未传入商家id，  @huang 20180918 -->
					<dl>
						<dt>领取商家</dt>
						<dd>
							<input type="text" bringBack="user_merchant_lingqu.showName"     value="<c:out value="${object.user_merchant_lingqu.showName }" escapeXml="true"/>"   >
							<input type="hidden" bringBack="user_merchant_lingqu.userId" name="object.userId_merchant_lingqu" value=""    >
							<a  class="btnLook" href="${basePath }v2/huiyuan/list.do?return_mod=lookup&userGroup_id=<%=CashierAction.getMerchantUserGroutId() %>" lookupGroup="user_merchant_lingqu"  rel="user_merchant_lingqu_lookup">查找</a>
						</dd>
					</dl>
					
					
					<!-- 增加领取会员随机功能  @huang 20180917 -->
					<div class="divider"></div>
					<dl>
						<dt style="font-size: 0.8rem;">领取会员随机</dt>
						<dd>
							<input checked="checked" type="checkbox"  name="user_huiyuan_lingqu_rand" value="<%=State.STATE_OK %>"    >
						</dd>
					</dl>
					...
					<dl>
						<dt>领取会员组</dt>
						<dd>
							<input type="text" bringBack="usergroup.name"     value="">
							<input type="hidden" bringBack="usergroup.id" name="object.usergroupId" value=""     >
							<a  class="btnLook" href="${basePath }v2/usergroup/list.do?return_mod=lookup" lookupGroup="usergroup"  rel="user_usergroup_lookup">查找</a>
						</dd>	
					</dl>
					<div class="divider"></div>
					<dl>
					...
					<div class="divider"></div>
					<dl>
						<dt style="font-size: 0.8rem;">领取时间随机</dt>
						<dd>
							<input checked="checked" type="checkbox"  name="lingqu_time_is_set" value="<%=State.STATE_OK %>"    >
						</dd>
					</dl>
					<div class="divider"></div>
					<dl>
						...
						<dd>
							<input name="lingqu_time_start" value="${lingqu_time_start }"  type="text" class="date" dateFmt="yyyy-MM-dd HH:mm:ss"  />
						</dd>
					</dl>
					<dl>
						<dt style="font-size: 0.8rem;">领取时间结束</dt>
						<dd>
							<input name="lingqu_time_end" value="${lingqu_time_end }"  type="text" class="date" dateFmt="yyyy-MM-dd HH:mm:ss"  />
						</dd>
					</dl>
			</fieldset>
		</div>
