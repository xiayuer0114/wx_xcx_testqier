		...
		<tbody>
			<c:forEach var="object" varStatus="i" items="${object_ite }">
				<tr target="id" rel="${object.id }" id="${object.id }">
					...
					<td><c:out value="${object.didianming }" escapeXml="true"/></td>
					<td><c:out value="${object.tishi}" escapeXml="true"/></td>
					<td><c:out value="${object.pic}" escapeXml="true"/></td>
					<td><c:out value="${object.picResult}" escapeXml="true"/></td>
 				</tr> 
			</c:forEach>
		</tbody>
	</table>
