			...
			<fieldset  >
					...
					<dl >
						...
						<dd class="lookup_dd">
							...
							<a  class="btnLook" href="${basePath }v2/huiyuan/list.do?return_mod=lookup" lookupGroup="user_huiyuan"  rel="user_huiyuan_lookup">查找</a>
						</dd> 
					</dl>
					<dl >
						<dt>发放商家：</dt>
					...
					<dl >
						...
						<dd> 
							<select class="combox" name="object.state" svalue="${object.state }">
										...
										<option value="<%=State.STATE_CLOSED %>">已停用</option>
