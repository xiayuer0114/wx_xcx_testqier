	...
	<div class="searchBar">
		<table class="searchContent">
			<tr> 
				...
				<td class="lookup_td">
					<input type="text" bringBack="user_merchant_gongxiang.showName"     value="<c:out value="${object.user_merchant_gongxiang.showName }" escapeXml="true"/>"   > 
					<input type="hidden" bringBack="user_merchant_gongxiang.userId" name="object.user_merchant_gongxiang_id" value="${object.user_merchant_gongxiang_id }"    >
					<a  class="btnLook" href="${basePath }v2/huiyuan/list.do?return_mod=lookup&userGroup_id=<%=CashierAction.getMerchantUserGroutId() %>" lookupGroup="user_merchant_gongxiang"  rel="user_merchant_lookup">查找</a>
				</td>
