		...
		<div class="pageFormContent" layoutH="56"> 
			<fieldset  >
					...
					<dl>
						...
						<dd class="lookup_dd">
							<%-- <input type="hidden" name="object.id"  value="<c:out value="${object.id }" escapeXml="true"/>"> --%>
							<input type="text"   bringBack="user_merchant2.showName"    value="<c:out value="${object.user_merchant_gongxiang.showName}" escapeXml="true"/>"     >
							<input type="hidden"  bringBack="user_merchant2.userId"  name="object.user_merchant_gongxiang_id"  value="${object.user_merchant_gongxiang_id }" escapeXml="true"/>
