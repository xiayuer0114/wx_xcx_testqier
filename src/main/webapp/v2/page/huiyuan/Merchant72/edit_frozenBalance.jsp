...
<div class="pageContent">
	<form method="post" action="${basePath }v2/huiyuan/frozenBalanceChange.do"class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
		 <fieldset>
			...
			<dl>
					<dt>变动冻结金额：</dt>
				<dd>
					<input type="text" name="frozen" value="" class=""   > 
				</dd>
			</dl>  
			<dl>
				<dt>备注说明：</dt>
