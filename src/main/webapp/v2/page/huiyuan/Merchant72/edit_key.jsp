...
<div class="pageContent" id="${currentTimeMillis }"  >
	<form method="post" action="${basePath }v2/huiyuan/resetKey.do"class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
		 <fieldset >
			...
			<div class="divider"></div>
				...
				<dt>原密钥：</dt>
				<dd> 
				<input type="text" name="key" value="${user.key }"   readonly="readonly"  class="readonly"> 
			</dd>
			</dl>
			<div class="divider"></div> 
			<dl>
				<dt>新密钥：</dt>
				<dd> 
				<input type="text" name="keyNew" value="<%=Md5Util.MD5Normal(UUID.randomUUID().toString()).substring(0, UserAction.key_length) %>"     > 
			</dd>
			</dl> 
		 </fieldset>
 		</div>
