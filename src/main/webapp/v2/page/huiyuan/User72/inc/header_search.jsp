	...
	<div class="searchBar">
		<table class="searchContent">
			...
			<tr >
					...
					<td>
						<select name="sort_filed" class="combox" svalue="${sort_filed }">
								<option    value="" >排序字段-不排序</option>
			                    <option    value="balance" >用户余额</option>
						</select>
					</td>
					<td>
						<select name="sort_type" class="combox" svalue="${sort_type }">
								<option    value="" >排序方式-不排序</option>
								<option    value="<%=QuerySort.desc %>" >降序</option>
			                    <option    value="<%=QuerySort.asc %>" >升序</option>
						</select>
					</td> 
					<td>
