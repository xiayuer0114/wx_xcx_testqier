...
<div class="pageContent">
	<form method="post" action="${basePath }v2/huiyuan/integralChange.do"class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
		 <fieldset >
				...
				<div class="divider"></div>
					...
					<dt>变动积分：</dt>
					<dd> 
					<input type="text" name="integral" value="" class=""   > 
				</dd>
				</dl>   
				<div class="divider"></div> 
				<dl>
