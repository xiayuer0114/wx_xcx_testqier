...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			...
			<th>状态</th>
			<th  width="40">
				<a class="btnSelect_bean" href="javascript:jQuery.bringBack({userRoleId:'', userRoleName:''})" title="清空">清空</a>
			</th>
		</tr>
		</thead>
		<tbody>
		<c:forEach var="userRole" varStatus="i" items="${userRole_list }">
			<tr target="id" rel="${userRole.id }">
				...
				<td>
					<a class="btnSelect_bean" href="javascript:jQuery.bringBack({userRoleId:'${userRole.id }', userRoleName:'${userRole.userV2.realName }'})" title="带回">带回</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
