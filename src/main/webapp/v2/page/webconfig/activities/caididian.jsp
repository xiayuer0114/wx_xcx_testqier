...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%><%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<fieldset >
			<dl>
				<dt style="font-size: 0.6rem;" >复活次数上限</dt>
				<dd>
					<input type="hidden"  name="name"  value="caididian_relife_count" >
					<input type="text" name="caididian_relife_count" value="<c:out value="${webConfig_caididian_relife_count }" escapeXml="true"/>"   >
				</dd>
			</dl>
			...
			<dl>
				<dt>活动开始</dt>
				<dd>
					<input type="hidden"  name="name"  value="caididian_startTime" > 
					<input type="text" name="caididian_startTime" value="<c:out value="${webConfig_caididian_startTime }" escapeXml="true"/>"  class="date" dateFmt="yyyy-MM-dd HH:mm:ss"  >
				</dd>
			</dl>
			<dl>
				<dt>活动结束</dt>
				<dd>
					<input type="hidden"  name="name"  value="caididian_endTime" > 
					<input type="text" name="caididian_endTime" value="<c:out value="${webConfig_caididian_endTime }" escapeXml="true"/>"  class="date" dateFmt="yyyy-MM-dd HH:mm:ss" >
				</dd>
			</dl>
			<div class="divider"></div> 
			<dl>
