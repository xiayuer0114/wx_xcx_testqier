...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <div class="pageContent" id="${currentTimeMillis }"  >
   	<form method="post" action="${basePath }v2/Merchant72/shenghe_RedEnvelopeChange.do"class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
		...
		<div class="pageFormContent" layoutH="56"> 
			<fieldset style="height: ${pageContent_height-75}px;">
				...
				<dl>
					<dt>变动金额：</dt>
					<dd>
						${object.merchant_redenvelope_balance_change_Fen/100 }
					</dd>
				</dl>
				<div class="divider"></div>
				<dl>
