...
<div class="pageContent">
						<div class="panelBar">
							<ul class="toolBar">
								...
								<%--<li><a class="icon" href="${basePath  }v2/pub/editPub.do?rootPubConlumnId=58774e27ef722c095388bd08&pubConlumnId=58774e27ef722c095388bd08&pub_link_id={pubId}"   target="dialog"  rel="pubEdit"><span>推荐到</span></a></li>--%>
							</ul>
						</div>
