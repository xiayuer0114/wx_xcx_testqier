	...
	<div class="searchBar">
		<table class="searchContent"  >
			...
			<tr style="width: 100%;float: left;">
				...
				<td>
					标签：<input type="text" name="tag_string" value="" />
				</td>
				<td>
					置顶：<input type="text" name="zhiDing" value="" />
				</td>
				<td>
...
<div class="pageContent">
						<div class="panelBar">
							<ul class="toolBar">
								...
								<li class="line">line</li>
								<li><a class="icon" href="${basePath  }v2/pub/editPub.do?rootPubConlumnId=${rootPubConlumnId }&pubConlumnId=58774e27ef722c095388bd08&pub_link_id={pubId}"   target="dialog"  rel="pubEdit"><span>推荐到</span></a></li>
								<li class="line">line</li>
								<li><a class="icon" href="${basePath  }v2/pub/editPub.do?id={pubId}&return_mod=show_xiaochengxu" target="dialog"  rel="pubEdit"><span>查向小程序连接</span></a></li>
							</ul>
						</div>
