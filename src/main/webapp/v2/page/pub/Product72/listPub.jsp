...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent"  >
			<tr style="width: 100%;float: left;" hidden="hidden">
				<td>
			...
			<tr style="width: 100%;float: left;">
				...
				<td class="lookup_td">
					...
					<input type="hidden" bringBack="user_merchant.userId" name="merchantId" value="${object.userId_merchant }"    >
...
<div class="pageContent">
						<div class="panelBar">
							<ul class="toolBar">
								...
								<li><a class="add" href="${basePath  }v2/pub/editPub.do?pubConlumnId=${pubConlumnId }&rootPubConlumnId=${rootPubConlumnId }"   target="dialog"  rel="pubEdit"><span>新增商品</span></a></li>
							...
							<tbody>
								<c:forEach var="pub" varStatus="i" items="${pub_ite }">
									<tr target="pubId" rel="${pub.id }">
										...
										<td>${pub.name }</td>
										<td>${pub.bianhao }</td>
										<td><c:out value="${pub.user_merchant.nickname }"/></td>
										<td>${pub.price_fen/100 }</td>
										<td>${pub.had_sale/100 }</td>
										<td>${pub.stock/100 }</td>
