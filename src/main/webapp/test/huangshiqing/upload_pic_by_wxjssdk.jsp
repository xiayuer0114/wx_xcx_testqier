...
<% 
	...
	System.out.println("basePath_:"+basePath_);
...
<script type="text/javascript">
  ...
  document.querySelector('#onMenuShareAppMessage').onclick = function () {
    wx.updateAppMessageShareData({
      ...
      link: 'http://tiesh.liebianzhe.com/?b=10006',
      imgUrl: 'http://tiesh.liebianzhe.com/activities/618/img/chai.png',
  ...
  document.querySelector('#uploadImage').onclick = function () {
    ...
    function upload() {
      wx.uploadImage({
        ...
        success: function (res) {
          i++;
          //alert('已 上 传：' + i + '/' + length);
          images.serverId.push(res.serverId);
          
       	 //成功则上传到服务器
          if(images.serverId!=null && images.serverId.length>0){
          	//alert("上传到微信服务器成功");
          	$.post('${basePath}test/huangshiqing/upload_to_server.jsp', {serverId:images.serverId[0]}, function(){	
      		});
          }
