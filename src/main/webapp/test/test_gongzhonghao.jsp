...
<%  
	...
	GaosanShareBusiness gongzonghaoShareBusiness = new GaosanShareBusiness();
	
	String guanzhuUserInfo = gongzonghao.create_qrcode(gongzonghaoShareBusiness);
	
	out.println(guanzhuUserInfo);
%>