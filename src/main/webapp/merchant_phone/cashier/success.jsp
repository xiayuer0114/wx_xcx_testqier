...
<head>
    ...
    <body id="body" style="background: url('${basePath }merchant_phone/cashier/${state }.jpg') no-repeat; background-size: 100%">
    <script type="text/javascript">

        function success_update(requestData) {
            $.post("${basePath}merchant_phone/cashier/success_update.jsp",requestData,function (msg) {
