...
<html>
	...
	<body style="height:100vh;width:100%;background:url(img/bg1-1.jpg) no-repeat;background-size:100% 100%;">
		...
		<div class="en2-1_15">
			...
			<div class="en2-13_15">
				<img src="img/problem21.png" />
			</div>
			<div class="en2-13_15">
				<img src="img/problem22.png" />
			</div>
			<div class="en2-13_15">
				<img src="img/problem23.png" />
			</div>
			<div class="en2-13_15">
				<img src="img/problem24.png" />
			</div>
			<div class="en2-15_15">
				<a class="btn_submit_next" link="${basePath }activities/qixi2018/en2-2_15.jsp"><img src="img/botton2.png" /></a>
			</div>
		</div>
	</body>
</html>
