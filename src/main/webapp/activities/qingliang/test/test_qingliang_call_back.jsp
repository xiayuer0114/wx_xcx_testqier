...
<%  
	...
	QingliangShareBusiness nazhongrenShareBusiness = new QingliangShareBusiness();
	
	String openid	= WebConfigContentTrade.getConfig("dev_open_id");
	
	nazhongrenShareBusiness.subscribe_call_back(defaultGongzonghao, "7438", openid);
