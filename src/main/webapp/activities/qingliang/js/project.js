...
function create_paymentrecord() {
	var qingliang_price_yuan_value = getInputValue("qingliang_price_yuan");
	...
	ajax_post(basePath + "activities/qingliang/event/create_pay_order.jsp",request_data, function(message) {
